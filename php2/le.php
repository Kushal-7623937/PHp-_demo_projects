...
if(isset($_POST['submit-btn'])){
	...
	$customertransport =$_POST['custransport'];

$duplicate =mysqli_query($conn,"SELECT * FROM excel WHERE customermail= '$customermail' OR customerid ='$customerid'");
if(mysqli_num_rows($duplicate) > 0){
	echo "username is already taken";
}
else{
	$sql ="INSERT INTO `excel`(`id` , `customername`,`customerid`,`customernumber`,`customermail`,`customerstorage`,`customertransport`) VALUES(0 , '$customername','$customerid','$customernumber','$customermail','$customerstorage','$customertransport')";
